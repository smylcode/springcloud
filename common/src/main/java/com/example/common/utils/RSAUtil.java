 ...
 *
 * @author gouchao
 * @since 2018.12.3 14:00
 */
public class RSAUtil {
    public static String modulus = "11856836377455121159887646283028405241886" +
            "0815535686988260144400469365874667958009048954577778063958115798" +
            "6868626938780367194943827162082868953123789966108521144023660032" +
            "5890009057873350932643102844404128106840214222566385326277383404" +
            "3573864265801057700378252231885634817137189746406535872577549731" +
            "467539635917";

    public static String public_exponent = "65537";

    public static String private_exponent = "10719403624886948269272976216021" +
            "9877409974568876961930732464954572377864016914293241231040989826" +
            "9606231757968264432652345336228722086049254397860514754900544311" +
            "6663668272897308014461652359237167644132044317902607341654023847" +
            "9040924773035645783755844901035027333854707344930773877301634554" +
            "515295829100035777473";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("加密耗时：" + (System.currentTimeMillis() - beginTime) + "mms");
        System.err.println("密文：" + mi);
        //解密后的明文
        beginTime = System.currentTimeMillis();
        ming = RSAUtil.decryptByPrivateKey(mi, priKey);
        System.out.println("解密耗时：" + (System.currentTimeMillis() - beginTime) + "mms");
        System.err.println("解密后的：" + ming);
